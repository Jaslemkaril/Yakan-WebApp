...
@section('title', 'Reset Password - Yakan')
            ...
            <div class="grid md:grid-cols-2 gap-0 auth-card">
                ...
                <div class="benefits-section hidden md:flex">
                    <div class="mb-8">
                        ...
                        <h3 class="text-2xl font-bold mb-2">Create Strong Password</h3>
                        <p class="text-white/80 text-sm">
                            Choose a secure password to protect your account and personal information.
                        </p>
                    </div>
