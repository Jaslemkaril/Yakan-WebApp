...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="bg-white shadow-sm border-b">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex items-center justify-between h-16">
                ...
                <a href="{{ route('admin.custom-orders.create.choice') }}" class="text-gray-500 hover:text-gray-700">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="bg-white rounded-lg shadow p-6 mb-8">
            ...
            <form action="{{ route('admin.custom-orders.create.product') }}" method="POST" id="customerForm">
                @csrf
        ...
        <div class="bg-white rounded-lg shadow p-6 mb-8">
            ...
            @else
                <div class="text-center py-12">
                    ...
                    <a href="{{ route('admin.custom-orders.create.choice') }}" class="inline-flex items-center px-4 py-2 bg-[#800000] text-white rounded-lg hover:bg-[#600000] transition-colors">
...
<form id="productSelectionForm" action="{{ route('admin.custom-orders.store.product') }}" method="POST" style="display: none;">
    @csrf
