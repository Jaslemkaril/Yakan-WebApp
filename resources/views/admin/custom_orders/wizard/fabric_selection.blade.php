...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <form action="{{ route('admin.custom-orders.store.fabric') }}" method="POST" class="space-y-8">
            @csrf
            ...
            <div class="flex justify-between items-center">
                <a href="{{ route('admin.custom-orders.create.choice') }}" class="px-6 py-3 bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition-colors font-medium">
                    ← Back to Choices
                </a>
