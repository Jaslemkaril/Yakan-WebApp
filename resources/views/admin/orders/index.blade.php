        ...
        <div class="mb-8">
            <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                ...
                <div class="flex flex-col sm:flex-row gap-3">
                    ...
                    <a href="{{ route('admin.orders.refund_requests.index') }}" class="px-6 py-3 bg-white text-[#800000] rounded-lg hover:bg-[#fef2f2] transition-all duration-300 shadow border border-[#800000] font-semibold flex items-center justify-center">
                        <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 10h11a8 8 0 018 8v2M3 10l6 6m-6-6l6-6"/></svg>
                        Refund Requests
                    </a>
