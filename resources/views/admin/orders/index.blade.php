...
<style>
    ...
    .status-shipped { 
        @apply bg-red-50 text-[#800000] border border-red-200;
    }
    .status-delivered { 
        @apply bg-green-100 text-green-800 border border-green-200;
    }
    ...
    .action-primary { @apply bg-red-50 text-[#800000] hover:bg-red-100; }
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 mb-8">
            ...
            <div class="stat-card">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        <p class="text-gray-600 text-xs font-bold uppercase tracking-wider mb-1">Pending Confirmation</p>
            ...
            <div class="stat-card">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        <p class="text-gray-600 text-xs font-bold uppercase tracking-wider mb-1">In Processing / Shipping</p>
            ...
            <div class="stat-card">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        <p class="text-gray-600 text-xs font-bold uppercase tracking-wider mb-1">Done Orders</p>
                        <p class="text-3xl font-bold text-gray-900">{{ $stats['delivered_orders'] }}</p>
                        <p class="text-xs text-gray-500 mt-1">Delivered + completed</p>
                    </div>
                    <div class="stat-card-icon">
            ...
            <form id="filterForm" action="{{ route('admin.regular.index') }}" method="GET" class="space-y-4">
                ...
                <div>
                    ...
                    <select name="status" class="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:ring-2 focus:ring-[#800000] focus:border-[#800000] transition-all duration-300">
                        ...
                        <option value="pending" {{ $activeStatusFilter === 'pending' ? 'selected' : '' }}>Pending / Confirmation</option>
                        <option value="processing" {{ $activeStatusFilter === 'processing' ? 'selected' : '' }}>In Processing / Shipping</option>
