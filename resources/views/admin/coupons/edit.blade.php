    ...
    <div class="bg-white rounded-xl shadow-lg overflow-hidden">
        <form method="POST" action="{{ route('admin.coupons.update', array_merge(['coupon' => $coupon->id], $authQ)) }}" class="p-8 space-y-6">
            ...
            <div class="border-b pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" name="code" value="{{ old('code', $coupon->code) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#800000] focus:border-transparent" required />
                        @error('code')<span class="text-red-600 text-sm mt-1">{{ $message }}</span>@enderror
                    </div>

                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Discount Type *</label>
                        <select name="type" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#800000] focus:border-transparent">
            ...
            <div class="border-b pb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" name="value" value="{{ old('value', $coupon->value) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#800000] focus:border-transparent" required />
                    ...
                    <div>
                        ...
                        <input type="number" step="0.01" min="0" name="min_spend" value="{{ old('min_spend', $coupon->min_spend) }}" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#800000] focus:border-transparent" />
                    ...
                    <div>
                        ...
                        <select name="applies_to" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#800000] focus:border-transparent" required>
                            <option value="shipping" @selected(old('applies_to', $coupon->applies_to ?? 'shipping')==='shipping')>Shipping Fee</option>
                            <option value="items" @selected(old('applies_to', $coupon->applies_to ?? 'shipping')==='items')>Product Items</option>
                        </select>
            ...
            <div class="flex items-center gap-3 p-4 bg-gray-50 rounded-lg">
                <input type="checkbox" id="active" name="active" value="1" class="w-4 h-4 text-[#800000] rounded focus:ring-2 focus:ring-[#800000]" @checked(old('active', $coupon->active)) />
            ...
            <div class="flex items-center gap-3 pt-6 border-t">
                <button type="submit" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-[#800000] to-[#600000] text-white rounded-lg font-semibold hover:from-[#600000] hover:to-[#500000] transition-all duration-300">
