            ...
            <div class="bg-white rounded-xl shadow-lg p-6 border-l-4 border-maroon-600 hover:shadow-xl transition-shadow duration-300">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text" name="base_color" value="{{ old('base_color', '#800000') }}" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-maroon-500" placeholder="#800000" />
