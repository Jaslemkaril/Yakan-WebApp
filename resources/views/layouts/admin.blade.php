...
<head>
    ...
    <link rel="icon" type="image/png" href="{{ asset('images/YakanLogo.png') }}">
    <link rel="shortcut icon" type="image/png" href="{{ asset('images/YakanLogo.png') }}">
...
<body class="font-sans antialiased" x-data="{ 
    ...
    <div class="flex min-h-screen">
        ...
        <aside class="sidebar-mobile w-72 bg-gradient-to-b shadow-2xl border-r flex flex-col fixed md:sticky md:top-0 md:h-screen inset-y-0 md:inset-y-auto left-0 z-40 transition-all duration-300 ease-in-out" 
           ...
           @php
               $isOrderStaff = auth()->check() && (string) auth()->user()->role === 'order_staff';
               $isDashboardActive = request()->routeIs('admin.dashboard', 'staff.dashboard')
                   || request()->is('admin/dashboard*')
                   || request()->is('staff/dashboard*');
               $isOrdersActive = request()->routeIs('admin.regular.*') || request()->is('admin/orders*');
               $isCustomOrdersActive = request()->routeIs('admin.custom-orders.*') || request()->is('admin/custom-orders*');
           @endphp

           <!-- Navigation -->
<nav class="flex-1 p-4 space-y-1 overflow-y-auto custom-scrollbar">
    <a href="{{ $isOrderStaff ? route('staff.dashboard') : route('admin.dashboard') }}" class="menu-item nav-link flex items-center space-x-3 px-4 py-3 rounded-lg group {{ $isDashboardActive ? 'nav-link-active' : '' }}" style="color: white;" onmouseover="this.style.backgroundColor='rgba(255,255,255,0.1)'" onmouseout="this.style.backgroundColor='transparent'">
    ...
    <a href="{{ route('admin.regular.index') }}" class="menu-item nav-link flex items-center space-x-3 px-4 py-3 rounded-lg group {{ $isOrdersActive ? 'nav-link-active' : '' }}" style="color: white; position: relative;" onmouseover="this.style.backgroundColor='rgba(255,255,255,0.1)'" onmouseout="this.style.backgroundColor='transparent'">
    ...
    <a href="{{ route('admin.inventory.index') }}" class="menu-item nav-link flex items-center space-x-3 px-4 py-3 rounded-lg group {{ request()->routeIs('admin.inventory.*') ? 'nav-link-active' : '' }}" style="color: white;" onmouseover="this.style.backgroundColor='rgba(255,255,255,0.1)'" onmouseout="this.style.backgroundColor='transparent'">
        ...
        <span class="sidebar-text font-medium" style="color: rgba(255,255,255,0.9);">Inventory</span>
    </a>

    <a href="{{ route('admin.inventory.history') }}" class="menu-item nav-link flex items-center space-x-3 px-4 py-3 rounded-lg group {{ request()->is('admin/inventory/history*') ? 'nav-link-active' : '' }}" style="color: white;" onmouseover="this.style.backgroundColor='rgba(255,255,255,0.1)'" onmouseout="this.style.backgroundColor='transparent'">
        <svg class="w-5 h-5 transition-colors flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24" style="color: rgba(255,255,255,0.7);" onmouseover="this.style.color='white'" onmouseout="this.style.color='rgba(255,255,255,0.7)'"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
        <span class="sidebar-text font-medium" style="color: rgba(255,255,255,0.9);">Stock History</span>
    </a>
