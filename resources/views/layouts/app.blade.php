            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex space-x-4">
                        <a href="https://www.facebook.com/TuwasYakanWeaver?mibextid=wwXIfr&rdid=OUFPpkeUUseMmdLH&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1Ad2HqsZzq#" target="_blank" rel="noopener" class="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-gray-700 transition-colors">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
                            </svg>
                        </a>
                        <a href="https://www.instagram.com/tuwasyakan/?igsh=MTl1OXdmcmN1ZjRodw%3D%3D" target="_blank" rel="noopener" class="w-10 h-10 bg-gray-800 rounded-lg flex items-center justify-center hover:bg-gray-700 transition-colors">
                            <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
    ...
    (function() {
        ...
        function appendTokenToLinks() {
            document.querySelectorAll('a[href]').forEach(function(a) {
                ...
                try {
                    ...
                    if (isAuthPath(url.pathname)) return; // Skip login/logout/register links
        ...
        window.fetch = function(input, init) {
            try {
                ...
                if (url.origin === window.location.origin && !url.searchParams.has('auth_token') && !isAuthPath(url.pathname)) {
                    url.searchParams.set('auth_token', token);
                    if (typeof input === 'string') {
                        input = url.toString();
                    } else if (input instanceof Request) {
        ...
        document.addEventListener('submit', function(e) {
            ...
            try {
                ...
                if (isAuthPath(actionUrl.pathname)) return; // Skip login/register/logout forms
            } catch(e) {}
