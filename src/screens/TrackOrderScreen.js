...
const getStyles = (theme) => StyleSheet.create({
  ...
  summaryCard:     { flex: 1, backgroundColor: theme.cardBackground, borderRadius: 14, padding: 12, alignItems: 'center', elevation: 3, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.07, shadowRadius: 6, gap: 4 },
  ...
  orderCard:       { backgroundColor: theme.cardBackground, borderRadius: 18, padding: 18, marginBottom: 16, elevation: 5, shadowColor: '#000', shadowOffset: { width: 0, height: 3 }, shadowOpacity: 0.10, shadowRadius: 10, borderLeftWidth: 4 },
  ...
  orderRefLabel:   { fontSize: 16, fontWeight: '700', color: theme.text },
