...
HTML);
    ...
    public function destroy(Request $request)
    {
        ...
        // Return a branded sign-out page instead of the plain "Redirecting to..." text.
        $homeUrl = json_encode(url('/'));
...
<body>
    <div class="card">
        ...
        <div class="icon-circle">
            <svg viewBox="0 0 24 24" fill="none" stroke="rgba(255,220,220,0.9)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                <path d="M9 21H5a2 2 0 01-2-2V5a2 2 0 012-2h4"/><polyline points="16 17 21 12 16 7"/><line x1="21" y1="12" x2="9" y2="12"/>
            </svg>
        </div>
        <h2>Signed out successfully</h2>
        <p class="sub">Thanks for visiting Yakan. See you again soon!</p>
        <div class="progress-bar"><div class="progress-fill"></div></div>
        <p class="status">REDIRECTING TO HOME</p>
    </div>
    <script>
        // Clear any stored auth tokens from localStorage
        try {
            localStorage.removeItem('yakan_auth_token');
            sessionStorage.removeItem('auth_token');
        } catch(e) {}
        setTimeout(function() { window.location.href = {$homeUrl}; }, 1400);
    </script>
</body>
</html>
HTML);
