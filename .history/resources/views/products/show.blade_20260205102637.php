                    ...
                    @if(auth()->check())
                        <form action="{{ route('reviews.store') }}" method="POST" class="space-y-4">
                                ...
                                <div class="flex gap-2">
                                    @for($i = 1; $i <= 5; $i++)
                                        <label class="cursor-pointer">
                                            ...
                                            <span class="text-3xl transition-colors hover:text-yellow-400" id="star{{ $i }}">☆</span>
                                        </label>
                                    @endfor
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" name="title" placeholder="Brief title for your review" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#800000] focus:border-transparent" required>
                            </div>
                            
                            <!-- Comment -->
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-2">Your Review</label>
                                <textarea name="comment" rows="4" placeholder="Share your experience with this product..." class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#800000] focus:border-transparent" required></textarea>
                            </div>
                            
                            <!-- Submit Button -->
                            <button type="submit" class="px-6 py-3 bg-[#800000] text-white rounded-lg font-semibold hover:bg-[#600000] transition-colors">
                                Submit Review
                            </button>
                        </form>
                    @else
