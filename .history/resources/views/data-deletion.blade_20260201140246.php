...
<div class="container py-12">
    <div class="max-w-4xl mx-auto">
        ...
        <div class="prose prose-lg">
            ...
            @if(Auth::check())
                <h3 class="text-xl font-bold mt-6 mb-3">Delete Your Account</h3>
                <div class="bg-red-50 p-6 rounded border-2 border-red-200 mb-6">
                    <p class="text-red-800 font-semibold mb-4">
                        ⚠️ Warning: This action is permanent and cannot be undone.
                    </p>
                    <p class="mb-4">
                        Clicking the button below will immediately delete your account and all associated data from our system.
                    </p>
            ...
            @else
                ...
                <div class="bg-blue-50 p-6 rounded mb-6">
                    <p class="mb-4">
                        You must be logged in to delete your account. <a href="{{ route('login') }}" class="text-blue-600 hover:underline font-semibold">Log in to your account</a> to proceed.
                    </p>
                </div>
            @endif
            
            <h3 class="text-xl font-bold mt-8 mb-3">Alternative: Request via Email</h3>
            <p>
