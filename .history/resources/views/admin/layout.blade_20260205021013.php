            ...
            <nav class="flex flex-col space-y-2">
                ...
                <div x-data="{ patternsOpen: false }" class="space-y-1">
                    ...
                    <div x-show="patternsOpen" class="pl-4 space-y-1">
                        ...
                        <a href="{{ route('fabric_types.index') }}" class="hover:bg-[#600000] p-3 rounded min-h-[44px] flex items-center text-sm">
                            <i class="fas fa-shirt mr-2"></i> Fabric Types
                        </a>
                        <a href="{{ route('intended_uses.index') }}" class="hover:bg-[#600000] p-3 rounded min-h-[44px] flex items-center text-sm">
