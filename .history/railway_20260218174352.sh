...
# NOTE: route:cache CANNOT be used because routes/web.php contains Closure-based routes
# php artisan route:cache
php artisan view:cache || echo "⚠️ view:cache failed, views will compile on-the-fly"
